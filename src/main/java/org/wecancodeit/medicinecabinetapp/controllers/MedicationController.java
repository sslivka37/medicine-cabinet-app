...
public class MedicationController {
	...
	public String findOneMedication(@RequestParam(value = "id") long id, Model model)
...
// public String addMedication(String medicationName, String dosageUnits, double
// dosageAmount, String medicationType,
...
// public String addMedication(String medicationName, String dosageUnits, double
// dosageAmount, String medicationType,
// String frequency, int count, LocalTime timeToTakeMedication, String
// instructions, Doctor doctor, Pharmacy pharmacy,
// Long alertName) {
// Optional<Alert> alert = alertRepo.findById(alertName);
// Medication newMedication = medicationRepo.findByName(medicationName);

// if(newMedication==null) {
// newMedication = new Medication(medicationName, dosageUnits, dosageAmount,
// medicationType,
...
// @RequestMapping("/add-medication")
// public Medication addMedication(String medicationName, String dosageUnits,
// double dosageAmount, String medicationType,
// String frequency, String instructions, String doctorName, String
// pharmacyName,
// String alertName) {
